...
# title: 認知ループAIエージェント
# role: 計画に基づき、情報検索、ツール利用、知識グラフ生成を反復的に実行し、包括的な分析結果を生成する。
...
from app.agents.query_refinement_agent import QueryRefinementAgent # <-- ここは正しくインポートされている
...
class CognitiveLoopAgent(AIAgent):
    ...
    def __init__(
        ...
        query_refinement_agent: QueryRefinementAgent, # <-- ここを修正
...
要約:"""
        ...
        if match:
            ...
            if browser_tool and hasattr(browser_tool, 'use_async'):
                ...
                if summarizer_tool and hasattr(summarizer_tool, 'use_async'):
                    ...
                    # Specialistツールは通常、直接クエリを受け付けて出力を返す
                    # ここでは、ウェブページの内容と質問を統合してツールに渡す
                    summary_query = f"ユーザーの質問: {question_part}\n\nウェブページの内容:\n{page_content}"
                    summary = await summarizer_tool.use_async(summary_query) # use_asyncが確実なため
                else:
    ...
    async def ainvoke(self, input_data: Dict[str, Any] | str) -> str:
        ...
        # ◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️↓修正開始◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️
        reasoning_instruction = input_data.get("reasoning_instruction", "") # reasoning_instructionを取得
        # ◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️↑修正終わり◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️
        ...
        final_input = {
            ...
            # ◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️↓修正開始◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️
            "reasoning_instruction": reasoning_instruction, # reasoning_instructionを追加
            # ◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️↑修正終わり◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️◾️
        }
