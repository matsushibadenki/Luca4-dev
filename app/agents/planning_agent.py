...
from app.prompts.manager import PromptManager # 修正
...
class PlanningAgent(AIAgent):
    ...
    def __init__(self, llm: Any, output_parser: Any, prompt_manager: PromptManager):
        self.llm = llm
        self.output_parser = output_parser
        self.prompt_template = prompt_manager.get_prompt("PLANNING_AGENT_PROMPT")
        super().__init__()
