...
from app.agents import prompts # Added import for WISDOM_SYNTHESIS_PROMPT
...
class ConsolidationAgent(AIAgent):
    ...
    def __init__(
        ...
        self.wisdom_synthesis_chain = prompts.WISDOM_SYNTHESIS_PROMPT | self.llm | self.output_parser # Added
        super().__init__()
